...
4. הנחיות לבניית השיעור:
   ...
   - יש להציע לפחות מסך אחד בכל פעילות.
...
5. הנחיות למיקום בתוכן הלמידה (שדה position):
   ...
   * סיכום נושא
   ...
   - הערה: חובה לבחור את סוג התצוגה רק מהרשימה הזו! אין להמציא סוגי תצוגה חדשים
   - חשוב! כל מסך חייב לכלול:
     1. סוג תצוגה (screen1/screen2/screen3)
     2. תיאור תצוגה תואם (screen1Description/screen2Description/screen3Description)
     חשוב ביותר !!!!:
   - חובה להציע תיאור מסך אם נבחר סוג תצוגה!!!!!
   - אין להציע סוג תצוגה ללא תיאור מסך!!!!!
